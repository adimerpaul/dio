...
<!--      </q-card-section>-->
      ...
      <q-card-section>
        <q-timeline color="primary" layout="comfortable" side="right">
          ...
          />
          <q-timeline-entry
            title="Derivación área psicológica"
            :subtitle="format(caso.fecha_derivacion_area_psicologica)"
            icon="psychology"
            :color="caso.fecha_derivacion_area_psicologica ? 'primary' : 'grey-5'"
          />
          <q-timeline-entry
            title="Aceptación área psicológica"
            :subtitle="format(caso.fecha_aceptacion_area_psicologica)"
            icon="psychology"
          ...
          <q-timeline-entry
            ...
            icon="people"
            :color="caso.fecha_derivacion_area_social ? 'primary' : 'grey-5'"
          />
          <q-timeline-entry
            title="Aceptación área social"
            :subtitle="format(caso.fecha_aceptacion_area_social)"
            icon="people"
