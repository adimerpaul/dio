...
export default {
  ...
  methods:{
    ...
    applyTemplate(val){
      ...
      if(val==='informe_psico')  this.form.contenido_html = InformeHtml.psicologico(base)
      if(val==='informe_legal')  this.form.contenido_html = InformeHtml.legal(base)
      if(val==='informe_social') this.form.contenido_html = InformeHtml.social(base)
    },
