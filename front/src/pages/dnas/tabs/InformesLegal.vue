  ...
  <q-card flat bordered class="q-pa-md">
    <div class="row items-center q-mb-sm">
      ...
      <div class="col-auto row items-center q-gutter-sm">
        ...
        <q-btn v-if="canEdit" color="green" icon="add_circle_outline" no-caps label="Crear informe" @click="openCreate"/>
      </div>
    </div>
    ...
    <q-dialog v-model="dialog" persistent maximized>
      <q-card>
        <q-bar class="bg-white text-dark">
          <div class="text-subtitle1">{{ mode==='view' ? 'Ver informe' : (form.id ? 'Editar informe' : 'Nuevo informe') }}</div>
...
<script>
export default {
  name: 'DnaInformesLegal',
  props: { caseId: { type:[String,Number], required:true }, caso:{ type:Object, default:null } },
  data: () => ({
    ...
    plantillasOptions:[
      { label:'Informe Legal (DNA)', value:'informe_legal' },
