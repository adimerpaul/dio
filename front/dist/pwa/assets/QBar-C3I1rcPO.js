...
`},informe_dio({numeroCaso:e,casoId:t,fecha:o,abogadoNombre:a,psicologoNombre:r,denunciante:n={},familiares:s=[],motivo:_="",antecedentes:C="",tecnicas:$="",conclusiones:c="",recomendaciones:q=""}){const d=(y,P="—")=>y==null||y===""?P:y;console.log(s);const h=(s&&s.length?s:[{nombre:"",edad:"",estado_civil:"",parentesco:"",ocupacion:""}]).map(y=>`
    <tr>
