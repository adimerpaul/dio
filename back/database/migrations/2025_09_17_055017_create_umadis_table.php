...
return new class extends Migration
{
    ...
    {
        Schema::create('umadis', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('relacion_denunciado', 80)->nullable();
            $table->string('grado_instruccion', 80)->nullable();
            $table->boolean('trabaja')->default(false);
            $table->string('ocupacion', 120)->nullable();
            $table->string('edad_aprox', 10)->nullable();
            $table->string('edada_exacto', 10)->nullable();
            $table->string('idioma', 80)->nullable();
            $table->string('celular1', 40)->nullable();
            $table->string('celular2', 40)->nullable();
            $table->string('telefono_fijo1', 40)->nullable();
            $table->string('telefono_fijo2', 40)->nullable();
            $table->string('direccion_actual', 160)->nullable();
