...
return new class extends Migration {
    public function up(): void {
        Schema::create('slims', function (Blueprint $table) {
            ...
            $table->string('denunciante_documento', 40)->nullable();
            $table->string('denunciante_nro', 30)->nullable();
            $table->string('denunciante_sexo', 15)->nullable();
            ...
            $table->string('denunciante_trabaja')->nullable();
            $table->string('denunciante_prox', 120)->nullable();
            ...
            $table->text('denunciante_domicilio_actual')->nullable();
            ...
            $table->string('denunciado_trabaja', 10)->nullable();
            ...
            $table->text('caso_descripcion')->nullable();
